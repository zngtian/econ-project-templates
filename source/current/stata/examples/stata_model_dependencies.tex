...
\begin{tikzpicture}[every node/.style={
    ...
    \node (rmconj_do) [fill=blue!15, shift={(8.5, 0)}]
    {
        rmconj.do
    };
    ...
    \node (table2_first_stage_est_do) [fill=blue!15, shift={(16, 3)}]
    {
    ...
    \node (research_paper_pdf) [shift={(19, 1.5)}]
    {
        research\_paper.pdf
    };


    \node (research_pres_30min_tex) [fill=blue!15, shift={(19, -0.5)}]
    {
        research\_pres\_30min.tex
    };

    \node (research_pres_30min_pdf) [shift={(19, -1.5)}]
    {
